...
-------------------------------------
### Barplot: How Category Relates to Status 
...
### Barplot: Number of Hurricanes for Each Decade

```{r, echo = FALSE, eval = TRUE}
histogram = ggplot(data = storms, mapping = aes(x=year, fill = category), ) + geom_histogram(binwidth = 10, position = "dodge2") 
#scale_fill_manual("Category", values = c("-1" = "purple", "0" = "blue", "1" = "cyan", "2" = "green", "3" = "yellow", "4" = "orange", "5" = #"red"))
ggplotly(histogram)
``` 
